...
-keep class moe.rgsekai.sekaitune.models.PersistPlayerState { *; }
-keep class moe.rgsekai.sekaitune.models.QueueData { *; }
-keep class moe.rgsekai.sekaitune.models.QueueType { *; }
-keep class moe.rgsekai.sekaitune.playback.queues.** { *; }
...
-keep class io.ktor.** { *; }
-dontwarn io.ktor.**
-keep class moe.rgsekai.sekaitune.moriextractor.BackendExtractorResponse { *; }
