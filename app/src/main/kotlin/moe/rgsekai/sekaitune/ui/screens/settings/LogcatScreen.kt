...
import moe.rgsekai.sekaitune.logcat.LogcatLevel
import moe.rgsekai.sekaitune.ui.utils.backToMain
import moe.rgsekai.sekaitune.viewmodels.LogcatEffect
import moe.rgsekai.sekaitune.viewmodels.LogcatScreenState
import moe.rgsekai.sekaitune.viewmodels.LogcatUiEntries
import moe.rgsekai.sekaitune.viewmodels.LogcatUiEntry
import moe.rgsekai.sekaitune.viewmodels.LogcatUiModel
import moe.rgsekai.sekaitune.viewmodels.LogcatViewModel
import moe.rgsekai.sekaitune.ui.component.IconButton as SekaiTuneIconButton
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("SekaiTune-log.txt", effect.uri)
