...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: moe.rgsekai.sekaitune.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: moe.rgsekai.sekaitune.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is moe.rgsekai.sekaitune.together.JoinDecision -> {
                            ...
                            is moe.rgsekai.sekaitune.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
