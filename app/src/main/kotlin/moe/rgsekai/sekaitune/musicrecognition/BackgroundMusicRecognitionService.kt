...
class BackgroundMusicRecognitionService : Service() {
    ...
    companion object {
        private const val ActionRecognizePlayback =
            "moe.rgsekai.sekaitune.action.RECOGNIZE_DEVICE_PLAYBACK"
        private const val ActionRecognizeMicrophone =
            "moe.rgsekai.sekaitune.action.RECOGNIZE_MICROPHONE"
        private const val ActionCancel =
            "moe.rgsekai.sekaitune.action.CANCEL_BACKGROUND_RECOGNITION"
