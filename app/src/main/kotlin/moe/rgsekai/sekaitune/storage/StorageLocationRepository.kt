...
package moe.rgsekai.sekaitune.storage
...
import moe.rgsekai.sekaitune.constants.GitHubContributorsEtagKey
import moe.rgsekai.sekaitune.constants.GitHubContributorsJsonKey
import moe.rgsekai.sekaitune.constants.GitHubContributorsLastCheckedAtKey
import moe.rgsekai.sekaitune.constants.GitHubTranslationContributorsJsonKey
import moe.rgsekai.sekaitune.constants.GitHubTranslationContributorsLastCheckedAtKey
import moe.rgsekai.sekaitune.constants.StorageFolderDisplayNameKey
import moe.rgsekai.sekaitune.constants.StorageFolderIdKey
import moe.rgsekai.sekaitune.constants.StorageFolderPathKey
import moe.rgsekai.sekaitune.constants.StorageFolderTreeUriKey
...
import moe.rgsekai.sekaitune.utils.ArtworkStorage
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".SekaiTune-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
...
private const val ExternalStorageRootDirectoryName = "SekaiTune"
...
private const val SavedArtworkCacheFileName = "SekaiTune_saved_artworks.json"
