...
package moe.rgsekai.sekaitune.lastfm
...
import moe.rgsekai.sekaitune.lastfm.models.LastFmError
import moe.rgsekai.sekaitune.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "SekaiTune"
    const val FALLBACK_COMPAT_SECRET = "SekaiTune"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "SekaiTune (https://github.com/rukamori/SekaiTune)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
